...
interface CheckoutModalProps {
  ...
  initialNotes?: string;
  onClose: () => void;
  onConfirm: (kitchen: Kitchen, items: any[], method: PaymentMethod, recipient: { name: string, phone: string, address: string }, notes: string) => void;
}
...
const CheckoutModal: React.FC<CheckoutModalProps> = ({ 
  ...
  const handleConfirm = () => {
    ...
    onConfirm(kitchen, items, method, recipient, notes);
  };
        ...
        <div className="space-y-8">
           ...
           <div className="space-y-4">
              ...
              <textarea 
                ...
                className="w-full px-5 py-4 rounded-[1.5rem] bg-brand-brown-50 border border-brand-brown-100 focus:border-brand-orange-500 outline-none font-medium text-sm text-brand-brown-900 transition-all resize-none h-24"
                placeholder="Vd: Không lấy ớt, ít cơm, nhắn shipper gọi trước khi tới..."
              />
           </div>
